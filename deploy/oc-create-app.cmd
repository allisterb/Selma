...
REM oc new-app selma:latest -e PGSQL=172.30.85.225 -e TYPINGDNA_KEY=%TYPINGDNA_KEY% -e TYPINGDNA_SECRET=%TYPINGDNA_SECRET% -e AZURE_SPEECH_KEY=%AZURE_SPEECH_KEY% -e AZURE_SPEECH_ENDPOINT=%AZURE_SPEECH_ENDPOINT% -e AZURE_FACE_KEY=%AZURE_FACE_KEY% -e AZURE_FACE_ENDPOINT=%AZURE_FACE_ENDPOINT%
