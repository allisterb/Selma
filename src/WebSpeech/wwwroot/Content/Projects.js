...
{
 "use strict";
 var Global,WebSharper,Obj,Projects,App,UI,ListModel,Var$1,Template,Index,Main,ListItem,Var,Operators,ConcreteVar,Snap,Doc,JavaScript,Pervasives,Templating,Runtime,Server,TemplateInstance,Collections,List,Storage,Seq,Abbrev,Fresh,EventTarget,Node,JS,Unchecked,Instance,Handler,Projects_Templates,Object,System,Guid,View,Dictionary,Instance$1,Arrays,ArrayStorage,Numeric,WindowOrWorkerGlobalScope,Docs,AttrProxy,CheckedInput,HashSet,TemplateInitializer,List$1,T,Enumerator,SC$1,DocElemNode,CharacterData,DomUtility,An,Client,Settings,Mailbox,DictionaryUtil,T$1,Templates,Attrs,Dyn,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$2,Array,Attrs$1,SC$3,AppendList,SC$4,Elt,HashSetUtil,SC$5,Scheduler,Easing,AsyncBody,SC$6,CT,HashSet$1,Prepare,Slice,KeyCollection,AttrModule,Strings,Updates,ValueCollection,BindVar,String,CancellationTokenSource,DomNodes,Char,Error,OperationCanceledException,Lazy,SC$7,SC$8,DynamicAttrNode,Queue,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,console,Math,Date;
 Global=self;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Obj=WebSharper.Obj=WebSharper.Obj||{};
 Projects=Global.Projects=Global.Projects||{};
 App=Projects.App=Projects.App||{};
 UI=WebSharper.UI=WebSharper.UI||{};
 ListModel=UI.ListModel=UI.ListModel||{};
 Var$1=UI.Var$1=UI.Var$1||{};
 Template=Projects.Template=Projects.Template||{};
 ...
 Projects_Templates=Global.Projects_Templates=Global.Projects_Templates||{};
 ...
 App=Projects.App=Runtime$1.Class({},Obj,App);
 ...
 Main=Index.Main=Runtime$1.Class({
  ...
  Create:function()
  {
   ...
   doc=Projects_Templates.main(completed[0]);
 ...
 ListItem=Index.ListItem=Runtime$1.Class({
  ...
  Create:function()
  {
   ...
   doc=Projects_Templates.listitem(completed[0]);
 ...
 Projects_Templates.main=function(h)
 {
 ...
 Projects_Templates.listitem=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 SC$5.$cctor=function()
 {
  ...
  SC$5.EmptyAttr=null;
  SC$5.BoolCheckedApply=Runtime$1.Curried3(function(_var,el,cb)
  {
  ...
  SC$5.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),Runtime$1.Curried(BindVar.ApplyValue,3,[g,function($1,$2)
  {
   return(s($1))($2);
  }])));
  ...
  SC$5.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$1,function($1,$2)
  {
   return(s$1($1))($2);
  }])));
  ...
  SC$5.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$2,function($1,$2)
  {
   return(s$2($1))($2);
  }])));
  ...
  SC$5.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$3,function($1,$2)
  {
   return(s$3($1))($2);
  }])));
  ...
  SC$5.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$4,function($1,$2)
  {
   return(s$4($1))($2);
  }])));
 };
