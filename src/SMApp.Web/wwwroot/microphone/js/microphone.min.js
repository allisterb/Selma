    ...
    (b = "0.8.5"),
        ...
        (f = {
                                    ...
                                    (d.onaudioprocess = function (b) {
                                        ...
                                        if (a.rec) {
                                            for (
                                                ...
                                                h = d.length,
                                                window.lastMicData = new Int16Array(h),
                                                f = k = 0;
                                                h >= 0 ? h >= k : k >= h;
                                                f = h >= 0 ? ++k : --k
                                            )
                                            ...
                                            return (
                                                e(
                                                    ...
                                                    h +
                                                    ", bytes=" +
                                                    window.lastMicData.byteLength
                                                ),
                                                a.conn.send(window.lastMicData)
                                            );
                                        }
                                    }),
                                    f.connect(d),
            ...
            audioend: {
                ...
                timeout: function () {
                    return (
                        this.handleError(new d("Wit timed out", { code: "TIMEOUT" })),
                        "ready"
                    );
                },
                error: function (a) {
                    return (
                        ...
                        this.handleError(
                            new d("Wit did not recognize intent", { code: "RESULT", data: a })
                        ),
                        "ready"
                    );
                },
