...
{
 "use strict";
 var Global,SMApp,Web,Client,WebSharper,UI,Var$1,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 Global=self;
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.DoSomething:524253151",[a.$0]):(b=null,Concurrency.Delay(function()
   {
