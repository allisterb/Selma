(function()
{
 ...
 SC$5=Global.StartupCode$SMApp_Web$Journal=Global.StartupCode$SMApp_Web$Journal||{};
 Symptoms=Web.Symptoms=Web.Symptoms||{};
 SC$6=Global.StartupCode$SMApp_Web$Symptoms=Global.StartupCode$SMApp_Web$Symptoms||{};
 Main=Web.Main=Web.Main||{};
 SC$7=Global.StartupCode$SMApp_Web$Main=Global.StartupCode$SMApp_Web$Main||{};
 Client=Web.Client=Web.Client||{};
 SC$8=Global.StartupCode$SMApp_Web$Client=Global.StartupCode$SMApp_Web$Client||{};
  ...
  return Concurrency.Delay(function()
  {
   return Concurrency.Bind(Witai.getMeaning2("4Y2BLQY5TWLIN7HFIV264S53MY4PCUAT",sentence),function(a)
   {
    ClientExtensions.debug("NLU",(function($1)
    {
     return function($2)
     {
      return $1("Wit.ai returned "+GeneratedPrintf.p$3($2)+" ");
     };
    }(Global.id))(a));
 ...
 Triple=Knowledge.Triple=Runtime.Class({
  toString:function()
  {
   return((((Runtime.Curried(function($1,$2,$3,$4)
   {
    return $1("("+SMApp$Web_GeneratedPrintf.p$9($2)+", "+SMApp$Web_GeneratedPrintf.p$11($3)+", "+SMApp$Web_GeneratedPrintf.p$17($4)+")");
 ...
 Question=Web.Question=Runtime.Class({
  toString:function()
  {
   return((((Runtime.Curried(function($1,$2,$3,$4)
   {
    return $1("Name: "+Utils.toSafe($2)+" Module: "+Utils.toSafe($3)+" Type: "+SMApp$Web_GeneratedPrintf.p$18($4)+" ");
 ...
 DialogueModule.cancel=function(d,debug,qn)
 {
  ...
  {
   return $1(SMApp$Web_GeneratedPrintf.p$19($2)+" at the top of the stack does not have the name "+Utils.toSafe($3)+".");
  ...
  debug((function($1)
  {
   return function($2)
   {
    return $1("Cancel "+SMApp$Web_GeneratedPrintf.p$19($2)+".");
   };
  }(Global.id))(q));
 };
 ...
 DialogueModule.popu=function(d,debug)
 {
  ...
  debug((function($1)
  {
   return function($2)
   {
    return $1("Pop "+SMApp$Web_GeneratedPrintf.p$16($2)+".");
   };
  }(Global.id))(m));
 };
 DialogueModule.pushu=function(d,debug,m)
 {
  debug((function($1)
  {
   return function($2)
   {
    return $1("Push "+SMApp$Web_GeneratedPrintf.p$16($2)+".");
   };
  }(Global.id))(m));
 ...
 QuestionDialogs.userAuthenticationDialogue=function(d,debug,q,u)
 {
  var t,n,passPhrase;
  function say(t$1)
  {
 ...
 Questions.ask=function(d,debug,q)
 {
  ...
  (q.get_Target())(d);
  m=q.get_Type();
  m.$==0?QuestionDialogs.userAuthenticationDialogue(d,debug,q,m.$0):void 0;
 };
 User.update=function(d)
 {
  var props,handle,endt,ask,m,$1,a,a$1,a$2,$2,a$3,a$4,a$5,$3,a$6,a$7,$4,a$8,a$9,a$10,$5,a$11,a$12,a$13,$6,a$14,a$15,a$16,b,$7,a$17,a$18,a$19,$8,a$20,a$21,a$22;
  function say(t)
  {
   DialogueModule.say(d,t);
  }
  ...
  function _User(a$23)
  {
   return DialogueModule["User'_"](d,a$23);
  }
  function Response(n,a$23)
  {
   return DialogueModule.Response_(d,n,a$23);
  }
  function _Response(n,a$23)
  {
   return DialogueModule["Response'_"](d,n,a$23);
  }
  function loginUser(u)
  {
   ...
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.getUser:-476535038",[u]),function(a$23)
    {
     var user;
     return a$23==null?(say((function($9)
     {
      return function($10)
      {
       return $9("I did not find a user with the name "+Utils.toSafe($10)+".");
      };
      ...
      $4:function()
      {
       ...
       say((function($9)
       {
        return function($10)
        {
         return $9("Do you want me to add the user "+Utils.toSafe($10)+"?");
        };
       }(Global.id))(u));
      }
     })),Concurrency.Zero()):(user=a$23.$0,(add("user",u),Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.updateUserLastLogin:-544214959",[user.Name]),function()
     {
      sayRandom(NLG.helloUserPhrases(),user.Name);
      return user.LastLoggedIn!=null?Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.humanize:990175070",[user.LastLoggedIn.$0]),function(a$24)
      {
       say((function($9)
       {
        return function($10)
        {
         return $9("You last logged in "+Utils.toSafe($10)+".");
        };
       }(Global.id))(a$24));
       return Concurrency.Zero();
      }):Concurrency.Zero();
  ...
  function addUser(u)
  {
   ...
   Concurrency.Start((b$1=null,Concurrency.Delay(function()
   {
    ...
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.addUser:1365094546",[u]),function(a$23)
    {
     return a$23.$==1?(ClientExtensions.error((((Runtime.Curried3(function($9,$10,$11)
     {
      return $9("Error adding user "+Utils.toSafe($10)+":"+Utils.toSafe($11)+".");
     }))(Global.id))(u))(a$23.$0)),say((function($9)
     {
      return function($10)
      {
       return $9("Sorry I was not able to add the user "+Utils.toSafe($10)+" to the system.");
      };
     }(Global.id))(u)),Concurrency.Zero()):(add("user",u),say((function($9)
     {
      return function($10)
      {
       return $9("Hello "+Utils.prettyPrint($10)+", nice to meet you.");
      };
   ...
   return new Question({
    ...
    $4:function()
    {
     say((function($9)
     {
      return function($10)
      {
       return $9("Do you want me to switch to the user "+Utils.toSafe($10));
      };
     }(Global.id))(u));
    }
   });
  ...
  }):m.$==1&&(a$6=_Response("authenticateUser",m.$0),a$6!=null&&a$6.$==1&&(a$7=NLU$1.StrA(a$6.$0[1]),a$7!=null&&a$7.$==1&&(m.$1.$==0&&($3=a$7.$0,true))))?(endt("authenticateUser"))(function()
  {
   ...
   Concurrency.Start((b$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.hasFace:724442589",[Arrays.get($3,2)]),function(a$23)
    {
     return a$23?(say("Face detected"),Concurrency.Zero()):(say(function($9)
     {
      return $9("Sorry I did not detect a face in the camera image. Make sure you can see the red square around your face in the camera window when you click the OK button.");
  ...
  }):m.$==1&&(a$8=NLU$1.No(m.$0),a$8!=null&&a$8.$==1&&(a$9=_Response("addUser",a$8.$0),a$9!=null&&a$9.$==1&&(a$10=NLU$1.PStr(a$9.$0[2]),a$10!=null&&a$10.$==1&&(m.$1.$==0&&($4=a$10.$0,true)))))?(endt("addUser"))(function()
  {
   say((function($9)
   {
    return function($10)
    {
     return $9("Ok I did not add the user "+Utils.toSafe($10)+". But you must login for me to help you.");
    };
   }(Global.id))($4));
  ...
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.getUser:-476535038",[$6.get_Value()]),function(a$23)
   {
    return a$23==null?(say((function($9)
    {
     return function($10)
     {
      return $9("Sorry, the user "+Utils.toSafe($10)+" does not exist.");
     };
    }(Global.id))($6.get_Value())),Concurrency.Zero()):(ask(switchUserQuestion(a$23.$0.Name)),Concurrency.Zero());
   });
  })),null):m.$==1&&(a$17=NLU$1.Yes(m.$0),a$17!=null&&a$17.$==1&&(a$18=Response("switchUser",a$17.$0),a$18!=null&&a$18.$==1&&(a$19=NLU$1.PStr(a$18.$0[2]),a$19!=null&&a$19.$==1&&(m.$1.$==0&&($7=a$19.$0,true)))))?(props.set_Item("user",$7),say((function($9)
  {
   return function($10)
   {
    return $9("Ok I switched to user "+Utils.prettyPrint($10)+".");
   };
  }(Global.id))($7))):m.$==1&&(a$20=NLU$1.No(m.$0),a$20!=null&&a$20.$==1&&(a$21=Response("switchUser",a$20.$0),a$21!=null&&a$21.$==1&&(a$22=NLU$1.PStr(a$21.$0[2]),a$22!=null&&a$22.$==1&&(m.$1.$==0&&($8=a$22.$0,true)))))?say((function($9)
  {
   return function($10)
   {
    return $9("Ok I did not switch to user "+Utils.toSafe($10)+".");
   };
  }(Global.id))($8)):DialogueModule.didNotUnderstand(d,function(m$1)
  {
   User.debug(m$1);
  },User.name());
 ...
 Journal.update=function(d)
 {
  ...
  function addEntry(e)
  {
   ...
   return Concurrency.Delay(function()
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.getTriples:-312873000",[e]),function(a$7)
    {
     var triples;
     return a$7.$==1?(say((function($8)
     {
      return function($9)
      {
       return $8("I could not add your journal entry. The following error occurred: "+Utils.prettyPrint($9));
      };
     }(Global.id))(a$7.$0)),Concurrency.Zero()):(triples=a$7.$0,triples.get_Length()>0?(Journal.debug((function($8)
     {
      return function($9)
      {
       return $8("Got "+Global.String($9)+" sentences from NLU server");
      };
     }(Global.id))(triples.get_Length())),add("journal_entry",[].concat(Arrays.ofSeq(triples)).reverse()),process_entry(),Concurrency.Zero()):(say(function($8)
     {
      return $8("Sorry I could not add an entry your journal entry.");
     }(Global.id)),Concurrency.Zero()));
    });
   });
  }
  ...
  List.ofArray(["What do you feel about your day today and why?","Describe the place that makes you feel the calmest. Is there anything that could be added to make it even better?","What makes you feel like the best version of yourself?","What made you feel uneasy today?","What makes you feel sad and why?","What makes you feel happy and why?","What makes you feel angry and why?","What makes you feel safe and why?","I have trouble sleeping when\u2026"]);
  m=DialogueModule.frame(d.$4);
  m.$==1&&(a=User$1(m.$0),a!=null&&a.$==1&&(a$1=NLU$1.Intent$1("journal",a.$0),a$1!=null&&a$1.$==1&&(a$2=NLU$1.Entity1Of1("journal_entry",a$1.$0[1]),a$2!=null&&a$2.$==1&&(m.$1.$==0&&($1=a$2.$0,true)))))?Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   ...
   return Concurrency.Bind(addEntry($1.get_Value()),function()
   {
 ...
 Symptoms.update=function(d)
 {
  ...
  function addSymptom(s,l,m$1)
  {
   ...
   return Concurrency.Start((b$1=null,Concurrency.Delay(function()
   {
    ...
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.addSymptomJournalEntry:162337456",[user().Name,s,l,m$1]),function(a$7)
    {
     return a$7.$==1?(say(function($8)
     {
 ...
 {
  var utterances,dispatch,handle,m,a,$1,a$1,a$2,a$3,a$4,$2,a$5,a$6,$3,a$7,a$8,$4,$5,a$9,a$10,$6,$7,a$11,$8;
  function say(t)
  {
   DialogueModule.say(d,t);
  }
  ...
  function _User(a$12)
  {
   return DialogueModule["User'_"](d,a$12);
  }
  utterances=d.$4;
  Main.debug(((((Runtime.Curried(function($9,$10,$11,$12)
  {
   return $9("Module "+Utils.toSafe($10)+" starting utterances:"+Utils.prettyPrint($11)+", questions: "+Utils.prettyPrint($12)+".");
  ...
  a!=null&&a.$==1?(Main.debug((function($9)
  {
   return function($10)
   {
    return $9("Agenda is "+SMApp$Web_GeneratedPrintf.p$19($10)+".");
   };
  ...
  {
   User.update(d$3);
  }):m.$==1&&(a$11=DialogueModule.User_(d,m.$0),a$11!=null&&a$11.$==1&&(($8=NLU$1.Intent$1("journal",a$11.$0),$8!=null&&$8.$==1)&&m.$1.$==0))?(dispatch(Journal.name()))(function(d$3)
  {
   Journal.update(d$3);
 ...
 {
  SC$8.$cctor();
  return SC$8.Dialogue;
 };
 Client.Utterances=function()
 {
  SC$8.$cctor();
  return SC$8.Utterances;
 };
 Client.Questions=function()
 {
  SC$8.$cctor();
  return SC$8.Questions;
 };
 ...
 SC$8.$cctor=function()
 {
  ...
  {
   var e,a,e$1,b,a$1,dt,b$1,a$2,et,b$2,$1,voices,$2,a$3,a$4,a$5,a$6,a$7,a$8,m,b$3,a$9,a$10,p;
   ...
   else
    {
     ...
     if(a$10!=null&&a$10.$==1)
     ...
     else
      {
       ...
       {
        return Concurrency.Bind(BabelNet.disambiguate(e$1),function(a$11)
        {
         return Concurrency.For(a$11,function(a$12)
         {
          Client.debug((function($3)
          {
           return function($4)
           {
            return $3(GeneratedPrintf.p($4));
           };
          }(Global.id))(a$12));
          return Concurrency.Zero();
         });
       ...
       {
        return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.getTriples:-312873000",[dt]),function(a$11)
        {
         return a$11.$==1?(Client.debug(a$11.$0),Concurrency.Zero()):Concurrency.For(a$11.$0,function(a$12)
         {
          return Concurrency.For(a$12,function(a$13)
          {
           Client.debug((function($3)
           {
            return function($4)
       ...
       {
        return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SMApp.Web:SMApp.Web.Server.getEmotionalTraits:-146145254",[et]),function(a$11)
        {
         return a$11.$==1?(Client.debug(a$11.$0),Concurrency.Zero()):Concurrency.For(a$11.$0,function(a$12)
         {
          Client.debug((function($3)
          {
           return function($4)
           {
            return $3(SMApp$Web_GeneratedPrintf.p$15($4));
           };
          }(Global.id))(a$12));
          return Concurrency.Zero();
         });
       ...
       },voices)):Client.ClientState().$==1?(a$3=Text.QuickHello(command),(a$3!=null&&a$3.$==1?($2=a$3.$0,true):(a$4=Text.QuickHelp(command),a$4!=null&&a$4.$==1?($2=a$4.$0,true):(a$5=Text.QuickYes(command),a$5!=null&&a$5.$==1?($2=a$5.$0,true):(a$6=Text.QuickNo(command),a$6!=null&&a$6.$==1?($2=a$6.$0,true):(a$7=Text.QuickNumber(command),a$7!=null&&a$7.$==1&&($2=a$7.$0,true))))))?(Client.debug((function($3)
       {
        return function($4)
        {
         return $3("Quick Text: "+SMApp$Web_GeneratedPrintf.p$16($4)+".");
        };
       }(Global.id))($2)),Main.update(Client.push($2)),Client.set_ClientState(ClientState.ClientReady)):(a$8=Text.JournalEntry(command),a$8!=null&&a$8.$==1?(m=a$8.$0,Client.debug((function($3)
       {
        return function($4)
        {
         return $3("Journal entry: "+SMApp$Web_GeneratedPrintf.p$16($4)+".");
        };
       }(Global.id))(m)),Main.update(Client.push(m)),Client.set_ClientState(ClientState.ClientReady)):Client.CUI().Wait((b$3=null,Concurrency.Delay(function()
       {
        Client.set_ClientState(ClientState.ClientUnderstand);
        Text.getUtterance(command,function(meaning)
        {
         var a$11,m$1;
         a$11=Text.HasUtterance(meaning);
         a$11!=null&&a$11.$==1?(m$1=a$11.$0,Client.debug(((((Runtime.Curried(function($3,$4,$5,$6)
         {
         ...
         },4))(Global.id))(m$1.get_Intent()))(m$1.get_Traits()))(m$1.get_Entities())),Main.update(Client.push(m$1))):(Client.debug("Text: Did not receive a meaning from the server."),Client["say'"]("Sorry I did not understand what you said."));
        });
        Client.set_ClientState(ClientState.ClientReady);
        return Concurrency.Zero();
  ...
  SC$8.CUI=CUI$1.New(null,null,null,(SDK.applicationId="4277115329081938617",sdk=new Global.SDKConnection(),web=new Global.WebAvatar(),web.version=8.5,web.connection=sdk,web.avatar="20926186",web.voice="cmu-slt",web.voiceMod="default",web.width=175,web.createBox(),web.addMessage(""),web.processMessages(0),web),false,new Dictionary.New$5(),new Global.TypingDNA());
  SC$8.MicState=MicState.MicNotInitialized;
  SC$8.ClientState=ClientState.ClientNotInitialzed;
  SC$8.Props=new Dictionary.New$5();
  SC$8.Output=[];
  SC$8.Questions=[];
  SC$8.Utterances=[];
  SC$8.Dialogue=new Dialogue({
   $:0,
   $0:Client.CUI(),
   $1:Client.Props(),
   $2:Client.Questions(),
  ...
  SC$8.synth=Global.speechSynthesis;
  SC$8.Main=new Interpreter({
   $:0,
   $0:function($1)
   {
 ...
 {
  return"Question ("+Utils.prettyPrint($1.$0)+", "+Utils.prettyPrint($1.$1)+", "+SMApp$Web_GeneratedPrintf.p$18($1.$2)+", "+SMApp$Web_GeneratedPrintf.p$20($1.$3)+", "+"<fun>"+")";
 };
 ...
 {
  return"{"+("start = "+Utils.prettyPrint($1.start))+"; "+("end = "+Utils.prettyPrint($1.end))+"}";
 };
 ...
 {
  return"{"+("tokenFragment = "+GeneratedPrintf.p$1($1.tokenFragment))+"; "+("charFragment = "+GeneratedPrintf.p$2($1.charFragment))+"; "+("babelSynsetID = "+Utils.prettyPrint($1.babelSynsetID))+"; "+("DBpediaURL = "+Utils.prettyPrint($1.DBpediaURL))+"; "+("BabelNetURL = "+Utils.prettyPrint($1.BabelNetURL))+"; "+("score = "+Utils.prettyPrint($1.score))+"; "+("cohrenceScore = "+Utils.prettyPrint($1.cohrenceScore))+"; "+("globalScore = "+Utils.prettyPrint($1.globalScore))+"; "+("source = "+Utils.prettyPrint($1.source))+"}";
 };
